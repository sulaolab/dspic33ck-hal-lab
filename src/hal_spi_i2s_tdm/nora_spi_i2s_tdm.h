...
//                  incorrectly (carried over by the port; docs/ck_silicon_findings.md
//                  "CLC1 50%-duty FS, measured" has always had the correct fact).
...
//     (measured, -Os; see docs/ck_silicon_findings.md defect 7). Do NOT add a separate
...
//     and docs/ck_silicon_findings.md defect 7). On AK encode/decode are the identity and
//     cost nothing, which is exactly why an author there cannot see the trap -- hence it is
//     stated in the shared contract rather than only in this backend's comments.
//===========================================================
typedef struct
{
...
// sl/clr/ior at THREE TIMES the cost (measured -- see docs/ck_silicon_findings.md defect 7).
...
// cycles per sample and 63% of this ISR (docs/ck_silicon_findings.md, "___muldi3: a typing
// decision costing 88 cycles per sample"). The multiply was never the cost; the shift WIDTH
// was.
//

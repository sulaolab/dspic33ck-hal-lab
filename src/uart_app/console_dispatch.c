 ...
 *   'd'  diagnostics  ?dt high-res timer read test          diag_console.c
 ...
 *        *tp path, *ta / *tb AVAS, *ti / *to gain, ?tq load, *ts stop, *tr restart,
 *        *tl lifecycle gates, *tm SYSTEM/sync-domain API. DM330030 owns no letter.

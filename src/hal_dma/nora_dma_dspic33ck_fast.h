 ...
 * BFINS, and IECx carries the tick and the console alongside these bits. Callers are
 * short critical sections on the audio path, so the cost of the branch is measured
 * there, not assumed. */

 ...
 *        used to be 1 cent and that alone did not fit this image). ?tc reports
 *        the committed and, if different, the still-pending value, both already
 *        snapped. The up/down arrow keys move in the same 5 cent steps -- see
 *        ev88g73a_transport_console_hotkey() below
 *
 ...
 */
void ev88g73a_classic_console_onmsg(app_console_msg_t *msg)
{
    uint8_t subcode;
